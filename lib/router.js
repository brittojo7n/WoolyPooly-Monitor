...
function estimateDay(accountStats, now) {
  ...
  if (accountStats) {
    if (accountStats.workersOnline != null && Number.isFinite(Number(accountStats.workersOnline))) {
      ...
      const current = accountStats.mode_stats && accountStats.mode_stats.pplns &&
        accountStats.mode_stats.pplns.default && accountStats.mode_stats.pplns.default.currentHashrate;
